...
export function initialBoard() {
  ...
  // White: back rank at y=2, pawns at y=3
  // Black: pawns at y=6, back rank at y=7
  // Symmetric layout with equal 2-rank buffers on the torus.
  for (let x = 0; x < 8; x++) {
